              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Color.fromARGB(255, 108, 180, 108),
                    fontSize: 17.0,
                    letterSpacing: 2.5,
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    onPrimary: Colors.black87,
                    primary: Color.fromARGB(255, 252, 247, 247),
                    padding:
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    primary: Color.fromARGB(255, 29, 102, 84),
                    padding:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 96, 104, 139),
      ), // AppBar
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text(
                  'Address: Pasima, Malasiqui, Pang' +
                      '\nPhone Number: +639072718021' +
                      '\nEmail: jdlocsing01@gmail.com',
                  style: TextStyle(
                    color: Color.fromARGB(255, 0, 0, 0),
                    fontFamily: 'Source Sans Pro',
                    fontSize: 18.0,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 96, 102, 139),
      ), // AppBar
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 102, 96, 139),
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
